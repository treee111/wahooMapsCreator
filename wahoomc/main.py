...
#        o_osm_maps.generate_land()
        ...
        asyncio.run(o_osm_maps.merge_splitted_tiles_with_land_and_sea(o_input_data.process_border_countries, o_input_data.contour, o_input_data.verbose))

        # Creating .map files
        asyncio.run(o_osm_maps.create_map_files(o_input_data.save_cruiser, o_input_data.tag_wahoo_xml, o_input_data.hdd_mode, o_input_data.verbose))
